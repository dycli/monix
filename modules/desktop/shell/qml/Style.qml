...
QtObject {
    ...
    readonly property color launcherBackgroundColor: Qt.rgba(40 / 255, 44 / 255, 52 / 255, 0.45)
    readonly property color popupBackgroundColor: Qt.rgba(40 / 255, 44 / 255, 52 / 255, 0.08)
    ...
    readonly property int popupRevealDuration: 320
