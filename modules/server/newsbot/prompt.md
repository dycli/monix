...
🗞 THE LEAD
<headline of the day's single biggest story>
<200-250 words, 2-3 short paragraphs: what happened, the key numbers and
names, essential context, and why it matters / what happens next>
→ <source outlet> <url>

🌍 WORLD
<headline, max ~12 words>
<100-150 words — AP-brief/Espresso depth, NOT a wire one-liner: what
happened with the concrete details, then a why-it-matters or
what-comes-next sentence>
→ <source outlet> <url>
<next story same shape>

...then each remaining category the same way.
